...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Cena: Schema.Attribute.Decimal & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ListaZawartosci: Schema.Attribute.DynamicZone<['shared.bulet1']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::module.module'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ZawartoscStandard: Schema.Attribute.Blocks;
  };
}
...
export interface ApiQaSectionQaSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Nazwa: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    qas: Schema.Attribute.Relation<'manyToMany', 'api::qa.qa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQaQa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Pytanie: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    qa_sekcjes: Schema.Attribute.Relation<
      'manyToMany',
      'api::qa-section.qa-section'
    >;
    updatedAt: Schema.Attribute.DateTime;
